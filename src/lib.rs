...
{
	let res: u8;
	asm!(".byte 0xf2; lock; cmpxchg %3,%1; setz %2" : "+a"(*oldp), "+m"(*ptr), "=r"(res) : "r"(newv) : "memory" : "volatile");
	res == 1
}
...
{
	let res: u8;
	asm!(".byte 0xf3; lock; cmpxchg %3,%1; setz %2" : "+a"(*oldp), "+m"(*ptr), "=r"(res) : "r"(newv) : "memory" : "volatile");
	res
}
...
{
	asm!(".byte 0xf2; mov %1,%0" : "=m"(*ptr) : "q"(val) : "memory" : "volatile");
}
...
{
	asm!(".byte 0xf3; mov %1,%0" : "=m"(*ptr) : "q"(val) : "memory" : "volatile");
}
...
{
	asm!(".byte 0xf2; lock; add %1,%0" : "+m"(*ptr) : "q"(val) : "memory" : "volatile");
}
...
{
	asm!(".byte 0xf2; lock; sub %1,%0" : "+m"(*ptr) : "q"(val) : "memory" : "volatile");
}
...
{
	asm!(".byte 0xf2; lock; or %1,%0" : "+m"(*ptr) : "q"(val) : "memory" : "volatile");
}
...
{
	asm!(".byte 0xf2; lock; and %1,%0" : "+m"(*ptr) : "q"(val) : "memory" : "volatile");
}
...
{
	asm!(".byte 0xf2; lock; xor %1,%0" : "+m"(*ptr) : "q"(val) : "memory" : "volatile");
}
...
{
	asm!(".byte 0xf3; lock; add %1,%0" : "+m"(*ptr) : "q"(val) : "memory" : "volatile");
}
...
{
	asm!(".byte 0xf3; lock; sub %1,%0" : "+m"(*ptr) : "q"(val) : "memory" : "volatile");
}
...
{
	asm!(".byte 0xf3; lock; or %1,%0" : "+m"(*ptr) : "q"(val) : "memory" : "volatile");
}
...
{
	asm!(".byte 0xf3; lock; and %1,%0" : "+m"(*ptr) : "q"(val) : "memory" : "volatile");
}
...
{
	asm!(".byte 0xf3; lock; xor %1,%0" : "+m"(*ptr) : "q"(val) : "memory" : "volatile");
}
